...
def train(root=True, binary=False, bert='bert-large-uncased', epochs=30, batch_size=32, save=False):
    ...
    for epoch in range(1, epochs):
        train_loss, train_acc = train_one_epoch(model, lossfn, optimizer, trainset, batch_size=batch_size)
        val_loss, val_acc = evaluate_one_epoch(model, lossfn, optimizer, devset, batch_size=batch_size)
